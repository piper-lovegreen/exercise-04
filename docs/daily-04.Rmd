...
I can add a regular hyperlink by just writing the URL: https://github.com/piper-lovegreen/exercise-04.git

Or I can have [linked text](https://github.com/piper-lovegreen/exercise-04.git).
...
big_cities %>% 
  ...
  scale_color_gradient(low = "steelblue3", high = "firebrick1") + 
